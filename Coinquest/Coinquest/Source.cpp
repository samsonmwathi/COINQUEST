...
void init() {
    //Load Font 
    headerFont.loadFromFile("Game_Assets/fonts/8-bit-pussab.ttf");
    //Load text
    headingText.setFont(headerFont);
    headingText.setString("COINQUEST");
    headingText.setCharacterSize(300);
    headingText.setFillColor(sf::Color::Yellow);

    //Load the textures
    coinTexture.loadFromFile("Game_Assets/graphics/coin.png");
    cactusTexture.loadFromFile("Game_Assets/graphics/cactus.png");
    groundTexture.loadFromFile("Game_Assets/graphics/ground.png");
